...
initialize();
if (module.hot) {
    script.__hmrId = '863cd1-hmr';
    module.hot.accept(()=>{
        setTimeout(()=>{
            initialize();
            if (!__VUE_HMR_RUNTIME__.createRecord('863cd1-hmr', script)) __VUE_HMR_RUNTIME__.reload('863cd1-hmr', script);
        }, 0);
    });
}
...
if (module.hot) module.hot.accept(()=>{
    __VUE_HMR_RUNTIME__.rerender('863cd1-hmr', render);
});
